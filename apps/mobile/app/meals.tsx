  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); void load(); }} />}>
        ...
        <View style={styles.titleRow}><View style={styles.titleCopy}><Text style={styles.title}>Meals</Text><Text style={styles.subtitle}>Everything you logged today, connected to your nutrition goals.</Text></View><Pressable onPress={() => router.push('/meal-builder')} style={styles.addButton}><Text style={styles.addButtonText}>+ Log meal</Text></Pressable></View>
        ...
        )) : <View style={styles.empty}><Text style={styles.emptyEmoji}>🍽️</Text><Text style={styles.emptyTitle}>{query ? 'Nothing matches' : 'No meals logged yet'}</Text><Text style={styles.body}>{query ? 'Try another food or meal name.' : 'Start by logging your first meal.'}</Text><Pressable onPress={() => router.push('/meal-builder')} style={styles.emptyAction}><Text style={styles.emptyActionText}>Log your first meal</Text></Pressable></View>}
