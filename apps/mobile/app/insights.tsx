    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={() => { setRefreshing(true); void load(); }} />}>
        ...
        {context ? <View style={styles.contextCard}>
          <View style={styles.contextHeader}><View><Text style={styles.contextEyebrow}>LIVE CONTEXT</Text><Text style={styles.cardTitle}>{context.primaryGoal ? `Focused on ${context.primaryGoal}` : 'Your day at a glance'}</Text></View><Text style={styles.brainIcon}>🧠</Text></View>
