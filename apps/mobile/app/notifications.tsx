  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      >
        ...
        <Text style={styles.subtitle}>Useful nudges from your assistant, kept here until you see them.</Text>
