...
const stackScreens = {
  '/': { animation: 'fade' as const }, '/assistant': { animation: 'slide_from_right' as const }, '/language': { animation: 'fade' as const }, '/auth': { animation: 'slide_from_right' as const }, '/onboarding': { animation: 'slide_from_right' as const }, default: { animation: 'fade' as const },
} as const;
...
export default function RootLayout() {
  ...
  return <View style={styles.root}><Stack screenOptions={screenOptions}><Stack.Screen name="index" options={stackScreens['/']} /><Stack.Screen name="assistant" options={stackScreens['/assistant']} /><Stack.Screen name="language" options={stackScreens['/language']} /><Stack.Screen name="auth" options={stackScreens['/auth']} /><Stack.Screen name="onboarding" options={stackScreens['/onboarding']} /></Stack>{showAssistantBubble ? <Pressable onPress={() => router.push('/assistant')} style={({ pressed }) => [styles.assistantBubble, pressed && styles.pressed]} accessibilityRole="button" accessibilityLabel="Open assistant" accessibilityHint="Opens your personal assistant"><BrandMark size={58} /></Pressable> : null}</View>;
}
