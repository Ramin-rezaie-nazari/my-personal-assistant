...
export type NutritionSummary = {
  ...
  goals:{calories:number|null;protein:number|null;waterMl:number|null};
  remaining:{calories:number|null;protein:number|null;waterMl:number|null};
  progress:{caloriesPercent:number|null;proteinPercent:number|null;waterPercent:number|null};
  status:{calories:string;protein:string;water:string};
};
