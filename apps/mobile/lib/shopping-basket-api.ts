...
export function getBasket(){return request<BasketItem[]>('/shopping/basket');}
export function completeBasketItem(id:string){return request(`/shopping/basket/${id}/complete`,{method:'POST'});}
