...
console.log('[MYPA] Khadijah asset sizes:', JSON.stringify({
  model: stat(modelPath), tokens: stat(tokensPath), phontab: stat(path.join(dataDir, 'phontab')), phonindex: stat(path.join(dataDir, 'phonindex')), vocoder: stat(vocoderPath),
}));
