...
const checks = [
  ...
  ['language options include regional az', languages.includes("export const REGIONAL_LANGUAGE_VARIANTS") && languages.includes("{ code: 'az', englishName: 'Azerbaijani Turkish (Iran)'") && languages.includes("export const LANGUAGE_OPTIONS: readonly AppLanguage[] = [...SUPPORTED_LANGUAGES, ...REGIONAL_LANGUAGE_VARIANTS];")],
