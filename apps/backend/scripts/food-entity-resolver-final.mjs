...
import supplementV9 from '../data/ingredient-taxonomy-supplement-v9.json' with { type: 'json' };
...
export const RESOLVER_VERSION = 'food-entity-resolver-final-v12';

const all = [...taxonomy, ...supplement, ...supplementV2, ...supplementV3, ...supplementV4, ...supplementV5, ...supplementV6, ...supplementV7, ...supplementV8, ...supplementV9];
