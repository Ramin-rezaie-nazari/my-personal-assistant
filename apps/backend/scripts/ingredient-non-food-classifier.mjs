const EQUIPMENT_PATTERNS = [
  ...
  /\b(?:baking dish|pie dish|microwave[- ]safe mug|deep bowl|microwave[- ]safe plastic bowl|measuring cup|fat separator|offset spatula|pastry bag|stand mixer|pressure cooker|instant pot|kitchen torch|ramekins?|bamboo skewers?|kitchen (?:string|twine)|metal or wooden skewers?|cookie cutters?|muffin tin|waffle iron|pizza stone|scraper|slotted spoon|wire rack|heavy pot|pie plate|jar|bowl or cup)\b/i,
...
const RECIPE_COMPONENT_PATTERNS = [
  ...
  /^(?:royal icing|caramel sauce|rhubarb compote|prepared marinara sauce|basic tart dough|extra[- ]flaky pastry dough)$/i,
];
