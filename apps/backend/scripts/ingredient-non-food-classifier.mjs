const EQUIPMENT_PATTERNS = [
  ...
  /\b(?:springform pan|cake pan|loaf pan|baking sheet|sheet pan|skillet|saucepan|sauté pan|saute pan|stockpot|dutch oven|roasting pan|ice cream maker)\b/i,
  /\b(?:baking dish|pie dish|microwave[- ]safe mug|deep bowl|microwave[- ]safe plastic bowl|measuring cup|fat separator|offset spatula|pastry bag|stand mixer|pressure cooker|instant pot|kitchen torch|ramekins?|bamboo skewers?|kitchen (?:string|twine))\b/i,
