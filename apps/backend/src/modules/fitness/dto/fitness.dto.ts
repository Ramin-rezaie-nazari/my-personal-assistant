...
export class FitnessGoalDto {
  ...
  @IsArray()
  @ArrayMaxSize(12)
  @IsIn(TARGET_AREAS, { each: true })
  targetAreas!: Array<(typeof TARGET_AREAS)[number]>;
...
export class FitnessProfileDto {
  ...
  disciplines!: Array<(typeof DISCIPLINES)[number]>;
  ...
  constraints!: Array<(typeof CONSTRAINTS)[number]>;
