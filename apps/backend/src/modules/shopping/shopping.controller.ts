...
export class ShoppingController{
 ...
 @Post('basket')add(@Request() req:{user:{id:string}},@Body() body:{foodId:string;name?:string;quantity:number;unit:string;source?:string;priority?:string}){return this.shopping.addToBasket(req.user.id,body);}
