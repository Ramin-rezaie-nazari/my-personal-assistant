...
@Module({
  imports: [ConversationEngineModule, DailyModule, WorkoutModule, HabitsModule, SupplementsModule, BrainIntegrationModule, ContextEngineModule, MemoryIntelligenceModule, UserIntelligenceModule, RemindersModule, CalendarModule, FitnessModule, YogaModule, CalisthenicsModule],
