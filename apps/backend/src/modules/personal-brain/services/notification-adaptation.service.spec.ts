...
describe('NotificationAdaptationService', () => {
  ...
  it('reduces frequency when resistance is high', () => {
    const result = service.recommend({ resistanceScore: 0.85, engagementScore: 0.1 } as any);
  ...
  it('keeps a pattern with strong engagement', () => {
    const result = service.recommend({ resistanceScore: 0.1, engagementScore: 0.9 } as any);
