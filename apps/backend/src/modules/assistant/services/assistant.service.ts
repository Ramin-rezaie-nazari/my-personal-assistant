...
const EXECUTABLE_ASSISTANT_ACTIONS = new Set([
  'create_reminder',
  'update_reminder',
  'cancel_reminder',
...
const LOCAL_INTENT_RESPONSES: Record<string, LocalIntentResponse> = {
  ADD_TO_BASKET: { intent: 'shopping', nextAction: 'add_to_basket', messages: {
    'fa-IR': 'باشه، به سبد خرید اضافه‌اش می‌کنم.', 'en-US': 'Sure, I’ll add it to your basket.', 'en-GB': 'Sure, I’ll add it to your basket.',
    'es-ES': 'Claro, lo añadiré a tu cesta.', 'es-MX': 'Claro, lo agrego a tu carrito.', 'fr-FR': 'Bien sûr, je l’ajoute à ton panier.', 'de-DE': 'Klar, ich füge es deinem Warenkorb hinzu.', 'it-IT': 'Certo, lo aggiungo al carrello.', 'pt-BR': 'Claro, vou adicionar ao seu carrinho.', 'ru-RU': 'Хорошо, добавлю это в корзину.', 'tr-TR': 'Tabii, bunu sepete ekleyeceğim.', 'ja-JP': 'わかりました。カートに追加します。', 'zh-CN': '好的，我会把它加入购物车。', 'ar-SA': 'بالتأكيد، سأضيفه إلى السلة.' } },
  REMOVE_FROM_BASKET: { intent: 'shopping', nextAction: 'remove_from_basket', messages: {
    'fa-IR': 'باشه، از سبد خرید حذفش می‌کنم.', 'en-US': 'Sure, I’ll remove it from your basket.', 'en-GB': 'Sure, I’ll remove it from your basket.',
    'es-ES': 'Claro, lo quitaré de tu cesta.', 'es-MX': 'Claro, lo quitaré de tu carrito.', 'fr-FR': 'Bien sûr, je le retire de ton panier.', 'de-DE': 'Klar, ich entferne es aus deinem Warenkorb.', 'it-IT': 'Certo, lo rimuovo dal carrello.', 'pt-BR': 'Claro, vou remover do seu carrinho.', 'ru-RU': 'Хорошо, уберу это из корзины.', 'tr-TR': 'Tabii, bunu sepetten çıkaracağım.', 'ja-JP': 'わかりました。カートから削除します。', 'zh-CN': '好的，我会把它从购物车移除。', 'ar-SA': 'بالتأكيد، سأزيله من السلة.' } },
  RECOMMEND_MEAL: { intent: 'nutrition', nextAction: 'recommend_meal', messages: {
    'fa-IR': 'حتماً، بر اساس اطلاعات خودت یک گزینه مناسب پیدا می‌کنم.', 'en-US': 'Absolutely. I’ll find a good option based on your profile.', 'en-GB': 'Absolutely. I’ll find a good option based on your profile.',
    'es-ES': 'Claro. Buscaré una opción adecuada según tu perfil.', 'es-MX': 'Claro. Buscaré una opción adecuada según tu perfil.', 'fr-FR': 'Bien sûr. Je vais chercher une option adaptée à ton profil.', 'de-DE': 'Klar. Ich suche eine passende Option auf Basis deines Profils.', 'it-IT': 'Certo. Cercherò un’opzione adatta al tuo profilo.', 'pt-BR': 'Claro. Vou encontrar uma opção adequada ao seu perfil.', 'ru-RU': 'Конечно. Подберу подходящий вариант по твоему профилю.', 'tr-TR': 'Tabii. Profiline göre uygun bir seçenek bulacağım.', 'ja-JP': 'もちろんです。あなたのプロフィールに合うものを探します。', 'zh-CN': '当然可以。我会根据你的个人情况找一个合适的选择。', 'ar-SA': 'بالتأكيد، سأبحث عن خيار مناسب وفقًا لملفك.' } },
  GET_NUTRITION_SUMMARY: { intent: 'nutrition', nextAction: 'get_nutrition_summary', messages: {
    'fa-IR': 'حتماً، خلاصه تغذیه امروزت رو بررسی می‌کنم.', 'en-US': 'Sure, I’ll check your nutrition summary for today.', 'en-GB': 'Sure, I’ll check your nutrition summary for today.',
    'es-ES': 'Claro, revisaré tu resumen de nutrición de hoy.', 'es-MX': 'Claro, revisaré tu resumen de nutrición de hoy.', 'fr-FR': 'Bien sûr, je vais vérifier ton résumé nutritionnel du jour.', 'de-DE': 'Klar, ich prüfe deine heutige Ernährungsübersicht.', 'it-IT': 'Certo, controllo il riepilogo nutrizionale di oggi.', 'pt-BR': 'Claro, vou conferir seu resumo nutricional de hoje.', 'ru-RU': 'Конечно, проверю твою сводку питания за сегодня.', 'tr-TR': 'Tabii, bugünkü beslenme özetini kontrol edeceğim.', 'ja-JP': 'もちろんです。今日の栄養の概要を確認します。', 'zh-CN': '好的，我会查看你今天的营养摘要。', 'ar-SA': 'بالتأكيد، سأراجع ملخص تغذيتك اليوم.' } },
  CREATE_REMINDER: { intent: 'reminder', nextAction: 'create_reminder', messages: {
    'fa-IR': 'حتماً، یادآوری رو برایت آماده می‌کنم.', 'en-US': 'Absolutely, I’ll set that reminder up for you.', 'en-GB': 'Absolutely, I’ll set that reminder up for you.',
    'es-ES': 'Claro, prepararé ese recordatorio para ti.', 'es-MX': 'Claro, prepararé ese recordatorio para ti.', 'fr-FR': 'Bien sûr, je vais préparer ce rappel pour toi.', 'de-DE': 'Klar, ich richte die Erinnerung für dich ein.', 'it-IT': 'Certo, preparo il promemoria per te.', 'pt-BR': 'Claro, vou preparar esse lembrete para você.', 'ru-RU': 'Конечно, подготовлю это напоминание для тебя.', 'tr-TR': 'Tabii, hatırlatıcıyı senin için hazırlayacağım.', 'ja-JP': 'もちろんです。リマインダーを設定します。', 'zh-CN': '当然可以，我会帮你设置这个提醒。', 'ar-SA': 'بالتأكيد، سأجهز هذا التذكير لك.' } },
  UPDATE_REQUEST: { intent: 'assistant', nextAction: 'update_contextual_request', messages: {
    'fa-IR': 'باشه، درخواست قبلی رو با تغییر جدیدت به‌روزرسانی می‌کنم.', 'en-US': 'Sure, I’ll update the previous request with that change.', 'en-GB': 'Sure, I’ll update the previous request with that change.', 'es-ES': 'Claro, actualizaré la solicitud anterior con ese cambio.', 'fr-FR': 'Bien sûr, je vais mettre à jour la demande précédente.', 'de-DE': 'Klar, ich aktualisiere die vorherige Anfrage entsprechend.', 'it-IT': 'Certo, aggiornerò la richiesta precedente con questa modifica.', 'pt-BR': 'Claro, vou atualizar o pedido anterior com essa alteração.', 'ru-RU': 'Хорошо, обновлю предыдущий запрос с изменением.', 'tr-TR': 'Tabii, önceki isteği bu değişiklikle güncelleyeceğim.', 'ja-JP': 'わかりました。前のリクエストをその変更で更新します。', 'zh-CN': '好的，我会按这个变化更新之前的请求。', 'ar-SA': 'بالتأكيد، سأحدّث الطلب السابق بهذا التغيير.' } },
  CANCEL_REQUEST: { intent: 'assistant', nextAction: 'cancel_contextual_request', messages: {
    'fa-IR': 'باشه، درخواست قبلی رو لغو می‌کنم.', 'en-US': 'Okay, I’ll cancel the previous request.', 'en-GB': 'Okay, I’ll cancel the previous request.', 'es-ES': 'De acuerdo, cancelaré la solicitud anterior.', 'fr-FR': 'D’accord, j’annule la demande précédente.', 'de-DE': 'Okay, ich storniere die vorherige Anfrage.', 'it-IT': 'Va bene, annullo la richiesta precedente.', 'pt-BR': 'Tudo bem, vou cancelar o pedido anterior.', 'ru-RU': 'Хорошо, отменю предыдущий запрос.', 'tr-TR': 'Tamam, önceki isteği iptal edeceğim.', 'ja-JP': 'わかりました。前のリクエストをキャンセルします。', 'zh-CN': '好的，我会取消之前的请求。', 'ar-SA': 'حسنًا، سأُلغي الطلب السابق.' } },
};
...
export class AssistantService {
  ...
  async process(input: string, userId: string, preferredLanguage?: string) {
    ...
    const safeExecutionResponse =
      executionResponse.nextAction && EXECUTABLE_ASSISTANT_ACTIONS.has(executionResponse.nextAction)
        ? executionResponse
        : { ...executionResponse, nextAction: undefined };
    const execution = safeExecutionResponse.nextAction
      ? await this.naturalActionExecutionService.execute(input, userId, safeExecutionResponse, {
          userId,
    ...
    const finalResponse = {
      ...
      message: execution?.executed ? execution.message : (execution?.message ?? safeExecutionResponse.message),
      ...(execution ? { execution } : {}),
      metadata: { ...(safeExecutionResponse.metadata ?? {}), localUnderstanding: local, contextualCommand, localPlan: plan, preferredLanguage: preferredLanguage ?? null },
    };
  ...
  private responseForLocalIntent(local: ReturnType<LocalLanguageUnderstandingService['understand']>): BrainResponse | undefined {
    ...
    return { intent: selected.intent, nextAction: selected.nextAction, message, confidence: local.confidence, metadata: { local: true, entities: local.entities, language: local.language } };
  }
