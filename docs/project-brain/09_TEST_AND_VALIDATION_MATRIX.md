...
A fresh post-merge native run is still required after the multilingual/local-first main changes; the workflow supports manual dispatch and main push path triggers.
