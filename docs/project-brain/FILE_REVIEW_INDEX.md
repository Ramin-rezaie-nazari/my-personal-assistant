...
Scope actually read: current-main baseline/Core; complete Prisma schema + all 39 migration SQL files; complete Assistant TypeScript source/test scope; complete enumerated Brain file-level scope; complete Food/Recipe/Nutrition/Meals/Recommendation/Budget file-level scope; relevant recipe nutrition script; complete enumerated Shopping/Inventory/Shopping Intelligence and substantial Price Intelligence; complete enumerated Life/Health; complete enumerated Fitness/Workout/Calisthenics/Gym/Yoga and related Personal Brain consumers; Platform/Test/CI enumerated manifests/E2E/workflows; substantial Mobile routes/clients/components; Mobile components/motion/scripts.
Scope not yet read: remaining Fitness-adjacent source; remaining Mobile route/component/library/native files; exhaustive platform/common/test inventory; repository-wide route/consumer/DB transaction map; runtime validation; full security/privacy; historical docs/branches.
...
Open questions: exact repo-wide source/line inventory; remaining scripts/media/native files; live DB drift; route/mobile/database consumers; runtime tests/build/device validation; complete historical reconciliation.
...
| BATCH-0009 | Mobile main route/client/native scope | READ_COMPLETELY | Enumerated high-use routes/clients/specs/config; remainder pending |
| BATCH-0010 | Mobile components/motion/scripts | READ_COMPLETELY | All 7 `apps/mobile/components/*.tsx`, `lib/motion.tsx`, both `apps/mobile/scripts/*.cjs` read completely; source-level findings recorded as PB-183..PB-185 |

## BATCH-0010 exact files

- `apps/mobile/components/AnimatedPressable.tsx`
- `apps/mobile/components/AnimatedSection.tsx`
- `apps/mobile/components/BrandMark.tsx`
- `apps/mobile/components/BrandWordmark.tsx`
- `apps/mobile/components/app-error-state.tsx`
- `apps/mobile/components/decision-trace-card.tsx`
- `apps/mobile/components/plan-status-card.tsx`
- `apps/mobile/lib/motion.tsx`
- `apps/mobile/scripts/prepare-khadijah-tts-model.cjs`
- `apps/mobile/scripts/start-lan.cjs`
